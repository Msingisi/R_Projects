...
# load dataset
sales <- read_csv("C:\\Users\\mzing\\Documents\\Projects\\R-Projects\\R-Guided-Project-sales\\sales2019.csv")
...
## The `date` column shows the date that the order of books was made. 
## This will help us distinguish between orders that were made before and after the new program was implemented. 
## `total_purchased` describes how many books were made, 
## and `user_submitted_review` looks like it's a hand typed review of the books themselves. 
